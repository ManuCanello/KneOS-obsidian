...
`identityBlock()` (armador de la capa de identidad) se exportó el 2026-09-15 — [[KneAI]] también la reusa ahora en su propio prompt, para no alucinar la bio de Manuel cuando le preguntan quién es.
